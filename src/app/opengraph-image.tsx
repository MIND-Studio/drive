...
export const alt = "Mind Drive — your files in your pod";
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <span style={{ fontSize: 60, fontWeight: 700, letterSpacing: -1 }}>Drive</span>
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        Files in your pod · built on Solid
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        A privacy-first Google Drive and Dropbox alternative built on Solid Pods — your bytes never
        leave the space you own.
      </div>
